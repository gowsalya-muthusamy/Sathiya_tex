      ...
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Manage your employee account information</p>
          </div>
        </div>
        ...
        <Card className="border-border shadow-md">
          <CardHeader>
            ...
            <CardDescription>Update your personal details used for tasks and contact.</CardDescription>
          </CardHeader>
          <form onSubmit={handleUpdate}>
            ...
            <CardFooter className="flex justify-end gap-3 pt-6 border-t border-border">
              <Button variant="outline" type="button" asChild disabled={isSaving}>
                <Link href="/dashboard/employee">Cancel</Link>
              </Button>
